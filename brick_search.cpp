...
/////////////////////////////////////////////////////////////////////
	...
	//variable to detect blobs didnt work
	...
	//variable to detect blobs did work and code didnt crash - no core dump
...
///////////////////////////////////////////////////////////////////////
	...
	for (int i = 0; i < keypoints.size() ; i++)
	{
		...
		{
		 std::atomic<bool> brick_found_{ true }; //set to true
		}
...
void BrickSearch::mainLoop()
{
  ...
  ROS_INFO_STREAM(" template Current pose: " << pose_2d);

  // Move forward 0.5 m
  pose_2d.x += 0.5 * std::cos(pose_2d.theta);
  pose_2d.y += 0.5 * std::sin(pose_2d.theta);

  ROS_INFO_STREAM("template Target pose: " << pose_2d);
  ...
  ROS_INFO("template Sending goal...");
